...
<body>
    ...
    <div class="container">
        ...
        <div id="multiple-choice" class="game-section">
            <h2 style="text-align: center; margin-bottom: 20px; color: #00796b;">Multiple Choice Questions</h2>
            
            <div class="question">
                <h3>1. What does "how come" (come mai) mean?</h3>
                <div class="options">
                    <div class="option" onclick="selectOption(this, false)">When will it happen?</div>
                    <div class="option" onclick="selectOption(this, true)">Why? For what reason?</div>
                    <div class="option" onclick="selectOption(this, false)">How much does it cost?</div>
                    <div class="option" onclick="selectOption(this, false)">Where is it located?</div>
                </div>
                <div class="feedback" id="mc-feedback-1" style="display: none;"></div>
            </div>

            <div class="question">
                <h3>2. What is the English equivalent of "un po'"?</h3>
                <div class="options">
                    <div class="option" onclick="selectOption(this, false)">A lot</div>
                    <div class="option" onclick="selectOption(this, true)">A little</div>
            ...
            <div class="question">
                <h3>3. What does "wake up" (svegliare) mean?</h3>
                <div class="options">
                    <div class="option" onclick="selectOption(this, false)">To go to sleep</div>
                    <div class="option" onclick="selectOption(this, true)">To stop sleeping</div>
                    <div class="option" onclick="selectOption(this, false)">To take a nap</div>
                    <div class="option" onclick="selectOption(this, false)">To dream</div>
                </div>
                <div class="feedback" id="mc-feedback-3" style="display: none;"></div>
            </div>

            <div class="question">
                <h3>4. What is "capodanno" in English?</h3>
                <div class="options">
                    <div class="option" onclick="selectOption(this, false)">Christmas Day</div>
                    <div class="option" onclick="selectOption(this, true)">New Year's Day</div>
                    <div class="option" onclick="selectOption(this, false)">Easter Sunday</div>
                    <div class="option" onclick="selectOption(this, false)">Birthday</div>
                </div>
                <div class="feedback" id="mc-feedback-4" style="display: none;"></div>
            </div>

            <div class="question">
                <h3>5. What is a "puppy" (cucciolo)?</h3>
                <div class="options">
                    <div class="option" onclick="selectOption(this, false)">An old dog</div>
                    <div class="option" onclick="selectOption(this, true)">A young dog</div>
                    <div class="option" onclick="selectOption(this, false)">A type of cat</div>
                    <div class="option" onclick="selectOption(this, false)">A wild animal</div>
                </div>
                <div class="feedback" id="mc-feedback-5" style="display: none;"></div>
            </div>

            <div class="question">
                <h3>6. What is the English equivalent of "vacanza"?</h3>
                <div class="options">
                    <div class="option" onclick="selectOption(this, false)">Work</div>
                    <div class="option" onclick="selectOption(this, true)">Holiday/Vacation</div>
                    <div class="option" onclick="selectOption(this, false)">School</div>
                    <div class="option" onclick="selectOption(this, false)">Meeting</div>
                </div>
                <div class="feedback" id="mc-feedback-6" style="display: none;"></div>
            </div>

            <div class="question">
                <h3>7. Which sentence uses "how come" correctly?</h3>
                <div class="options">
                    <div class="option" onclick="selectOption(this, false)">"How come is the weather today?"</div>
                    <div class="option" onclick="selectOption(this, true)">"How come you're late for the meeting?"</div>
                    <div class="option" onclick="selectOption(this, false)">"How come do you want coffee?"</div>
                    <div class="option" onclick="selectOption(this, false)">"How come to the supermarket?"</div>
                </div>
                <div class="feedback" id="mc-feedback-7" style="display: none;"></div>
            </div>

            <div class="question">
                <h3>8. When is New Year's Day celebrated?</h3>
                <div class="options">
                    <div class="option" onclick="selectOption(this, false)">December 25th</div>
                    <div class="option" onclick="selectOption(this, true)">January 1st</div>
                    <div class="option" onclick="selectOption(this, false)">February 14th</div>
                    <div class="option" onclick="selectOption(this, false)">March 17th</div>
                </div>
                <div class="feedback" id="mc-feedback-8" style="display: none;"></div>
            </div>

            <div class="question">
                <h3>9. What might someone do on a holiday/vacation?</h3>
                <div class="options">
                    <div class="option" onclick="selectOption(this, false)">Work extra hours</div>
                    <div class="option" onclick="selectOption(this, true)">Travel to another country</div>
                    <div class="option" onclick="selectOption(this, false)">Attend daily meetings</div>
                    <div class="option" onclick="selectOption(this, false)">Study for exams</div>
                </div>
                <div class="feedback" id="mc-feedback-9" style="display: none;"></div>
            </div>

            <div class="question">
                <h3>10. Which is NOT a characteristic of a puppy?</h3>
                <div class="options">
                    <div class="option" onclick="selectOption(this, false)">Playful</div>
                    <div class="option" onclick="selectOption(this, true)">Very old</div>
                    <div class="option" onclick="selectOption(this, false)">Young</div>
                    <div class="option" onclick="selectOption(this, false)">Energetic</div>
                </div>
    ...
    <script>
        ...
        function checkFillBlanks() {
            ...
            blanks.forEach((blank, index) => {
                ...
                // Special handling for phrases with apostrophes and multiple words
                const normalizedUserAnswer = userAnswer === "new year's day" || userAnswer === "new years day" || userAnswer === "new year day" ? "new year's day" : 
                                            userAnswer === "a little" || userAnswer === "alittle" ? "a little" :
                                            userAnswer === "how come" || userAnswer === "howcome" ? "how come" :
                                            userAnswer === "wake up" || userAnswer === "wakeup" ? "wake up" : userAnswer;
        ...
        function updateScore() {
            // Total score from all sections (6 fill-blanks + 6 matching + 10 multiple choice = 22 max)
